...
namespace GoogleSheetsForUnity
{
    public static class Drive
    {
        ...
        {            
            ...
            if(_currentStatus == "Object not found.")
            {
                Login.accounterror();
            }

            if(_currentStatus == "Worksheet table was not found.")
            {
                SpreadsheetsExample.newTable();
            }

            if(_currentStatus == "Operation timed out, connection aborted. Check your internet connection and try again.")
            {
                Login.accounterror();
            }
        }
